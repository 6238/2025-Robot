...
public class RemoveAlgaeCommand extends Command{
    ...
    public RemoveAlgaeCommand(SwerveSubsystem driveSubsystem, ElevatorSubsystem elevator, DoubleSupplier speed) {
    ...
    public void initialize() {
        ...
        startHeight = m_elevatorSubsystem.getHeight() / Constants.Elevator.ElevatorHeights.ELEVATOR_GEAR_RATIO;
    }
