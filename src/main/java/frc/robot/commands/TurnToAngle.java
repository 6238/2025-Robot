...
public class TurnToAngle extends Command {
  ...
  public TurnToAngle(SwerveSubsystem swerve, DoubleSupplier targetAngle) {
  ...
  @Override
  public void execute() {
    double turnValue = turn_pid.calculate(
  ...
  public boolean isFinished() {
    return Math.abs(targetAngle.getAsDouble() - swerve.getPose().getRotation().getDegrees()) <= Swerve.TURN_THRESHOLD;
  }
}
